...
import styles from "./profitSharingActionHeader.module.scss";
import SearchIcon from "@/svg/searchIcon";
import FilterIcon from "@/svg/filterIcon";
import { motion, AnimatePresence } from "framer-motion";
import ExportIcon from "@/svg/exportIcon";

export default function ProfitSharingActionHeader({
  onExport,
  search,
  onSearchChange,
  appliedFilters,
  ...
  return (
    <div className={styles.profitSharingActionHeader}>
